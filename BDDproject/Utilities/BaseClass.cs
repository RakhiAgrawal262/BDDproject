...
namespace BDDproject.Utilities
{
    [Binding]
    public class BaseClass
    {
        ...
        [BeforeTestRun]
        public static void GenerateRepor()
        {
            var htmlReport = new ExtentHtmlReporter
                (@"C:\Users\DELL\source\repos\BDDproject\BDDproject\Hooks\\index.html");
            ...
            Log.Logger = new LoggerConfiguration().MinimumLevel.ControlledBy(levelSwitch: loggingLevel).WriteTo.File
                (@"C:\Users\DELL\source\repos\BDDproject\BDDproject\Hooks\Logs",
